...
public class HomeController {
	...
	//@Autowired
	@Resource(name="camera4") // camera4 이름을 가진 객체 주입
	private Camera camera4;
	@Autowired(required=false) //주입되는 객체(recoder)가 없어도 허용
	private Recoder recoder; //recoder = null로 저장
	
	private List<InfraredRaySensor> sensors;
	@Autowired
	//AlarmDevice객체 (SmsAlarmDevice 객체), Viewer(SmartPhoneView 객체) 객체 주입
	...
	@PostConstruct //객체생성 후에 호출되는 메서드
